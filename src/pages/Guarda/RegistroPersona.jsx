        ...
        <div className="bg-gray-100 h-screen flex flex-col">
            ...
            <div className="flex-1 flex flex-col md:flex-row">
                ...
                <div className="flex-1 flex items-center justify-center p-4 bg-white border border-gray-300 rounded-lg shadow-md">
                    <div className="w-full max-w-xl">
                        ...
                        <form className="space-y-4">
                            <div>
                                <label htmlFor="nombresC" className="block text-sm font-medium text-black">Nombres completos</label>
                                <input
                                    type="text"
                                    id="nombresC"
                                    name="nombresC"
                            ...
                            <div>
                                <label htmlFor="documento" className="block text-sm font-medium text-black">Documento de identificación</label>
                                <input
                                    type="text"
                                    id="documento"
                                    name="documento"
                            ...
                            <div className="mb-4">
                                <label htmlFor="diligencia" className="block text-sm font-medium text-black">Diligencia a realizar</label>
                                <textarea
                                    id="diligencia"
                                    name='diligencia'
                                    rows="3"
                ...
                <div className="flex-1 flex flex-col items-center justify-center ">
                    ...
                    />
                    <p className='text-center text-black'>Esto es solo para personas que no pertencen a el sena y solo van a entrar a hacer algunas
                        diligencias en especifico
                    </p>
                </div>
            </div>
        </div>
