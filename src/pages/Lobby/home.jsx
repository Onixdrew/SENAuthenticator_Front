        ...
        <div>
            ...
            <main className="p-8 max-w-5xl mx-auto">
                ...
                <section id="nuestros-servicios" className="mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Nuestros Servicios</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="p-6 bg-green-300 rounded-lg shadow-lg">
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Reconocimiento Facial</h3>
                            <p className="text-gray-700">
                                Utilizamos tecnología avanzada de reconocimiento facial para garantizar la seguridad en nuestras instalaciones.
                            </p>
                        </div>
                        <div className="p-6 bg-green-300 rounded-lg shadow-lg">
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Monitoreo en Tiempo Real</h3>
                            <p className="text-gray-700">
                                Monitorea en tiempo real las entradas y salidas, con alertas inmediatas ante cualquier irregularidad.
                            </p>
                        </div>
                        <div className="p-6 bg-green-300 rounded-lg shadow-lg">
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Reportes Detallados</h3>
                            <p className="text-gray-700">
                ...
                <section id="sobre-la-app" className="mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Sobre la App</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 bg-green-300 rounded-lg shadow-lg">
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">¿Qué es SENAuthenticator?</h3>
                            <p className="text-gray-700">
                        ...
                        <div className="p-6 bg-green-300 rounded-lg shadow-lg">
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Características Principales</h3>
