            ...
            <main className="">
                <section className="  mb-12 h-[80vh] flex justify-center items-center w-full ">
                    <div className='max-w-[80%] flex  justify-center items-center'>
                        <div>
                            <h1 className="text-7xl font-bold text-gray-900 mb-10">Bienvenido a SENAuthenticator</h1>
                            <p className="text-lg text-gray-700 mb-8">
                                Nuestra misión es ofrecer una solución de seguridad avanzada con tecnología de reconocimiento facial para proteger tus instalaciones y asegurar un control de acceso eficiente.
                            </p>
                            <a href="https://www.instagram.com/senauthenticator?igsh=NG5yOGpveTZiN3Ay"
                ...
                <section className=" mb-12 h-[100vh] bg-custom-gris flex justify-center items-center w-full">
                    <div className='max-w-[80%] flex justify-center items-center'>
                        <div className=" max-w-5xl w-full md:w-1/2 mb-6 md:mb-0">
                            <img
                                src="https://cdn-icons-png.flaticon.com/512/2223/2223126.png"
                                alt="Reconocimiento Facial en el SENA"
                                className="object-cover w-full h-65 rounded-lg "
                            />
                        </div>
                        ...
                        <div className="w-full md:w-1/2 md:pl-8">
                            ...
                            <p className="text-lg text-gray-700 mb-4">
                                SENAuthenticator es una aplicación de Reconocimiento Facial con IA diseñada para ofrecer un control preciso y eficiente en las instalaciones del SENA Alto Cauca.
                            </p>
                            <p className="text-lg text-gray-700 mb-4">
                                Nuestra tecnología avanzada garantiza una alta seguridad y facilita el monitoreo en tiempo real para una mejor gestión del acceso.
                            </p>
                            <a href="https://www.instagram.com/senauthenticator?igsh=NG5yOGpveTZiN3Ay"
                                target="_blank" rel="noopener noreferrer"
                ...
                <section id="nuestros-servicios" className="  mb-12 h-[100vh] flex justify-center items-center w-full">
                    <div className='max-w-[80%] gap-16 flex flex-col justify-center items-center'>
                        <h2 className="text-7xl font-bold text-gray-900 mb-6 ">Nuestros Servicios</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="p-6 rounded-lg hover:scale-105 transition-transform">
                                <h3 className="text-2xl font-semibold text-gray-800 mb-4 text-center">Reconocimiento Facial</h3>
                                <p className="text-center text-gray-700">
                                    Utilizamos tecnología avanzada de reconocimiento facial para garantizar la seguridad en nuestras instalaciones.
                                </p>
                            </div>
                            <div className="p-6 rounded-lg  hover:scale-105 transition-transform">
                                <h3 className="text-2xl font-semibold text-gray-800 mb-4 text-center">Monitoreo en Tiempo Real</h3>
                                <p className="text-center text-gray-700">
                                    Monitorea en tiempo real las entradas y salidas, con alertas inmediatas ante cualquier irregularidad.
                                </p>
                            </div>
                            <div className="p-6 rounded-lg  hover:scale-105 transition-transform">
                                <h3 className="text-2xl font-semibold text-gray-800 mb-4 text-center">Reportes Detallados</h3>
                                <p className="text-center text-gray-700">
                ...
                <section id="sobre-la-app" className="  bg-custom-gris mb-12 h-[100vh] flex justify-center items-center w-full">
                    <div className='max-w-[80%] flex-col flex gap-16 justify-center items-center' >
                        <h2 className="text-7xl font-bold text-gray-900 mb-6">Sobre la App</h2>
                        <div className=" grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className=" rounded-lg  rounded-lg p-6 rounded-lg hover:scale-105 transition-transform ">
                                <h3 className=" text-2xl font-semibold text-gray-800 mb-4 text-center">¿Qué es SENAuthenticator?</h3>
                            ...
                            <div className="p-6 rounded-lg hover:scale-105 transition-transform  rounded-lg  rounded-lg ">
                                <h3 className=" text-2xl font-semibold text-gray-800 mb-4 text-center">Características Principales</h3>
                                <ul className=" list-disc list-inside text-gray-700">
                                    ...
                                    <li>Seguridad mejorada para todas las personas que ingresan a las instalaciones.</li>
                                </ul>
                            </div>
                        </div>
                ...
                <section id="testimonios" className="   mb-12 h-[100vh] flex justify-center items-center w-full">
                    <div className='max-w-[80%] flex-col gap-16 flex justify-center items-center'>
                        <h2 className="text-7xl font-bold text-gray-900  mb-14">Testimonios</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-6 rounded-lg hover:scale-105 transition-transform bg-white">
                                <blockquote className="  text-lg text-gray-700 text-center">
                                    "SENAuthenticator ha transformado la manera en que gestionamos la seguridad en nuestras instalaciones. La integración y precisión del reconocimiento facial son impresionantes."
                                </blockquote>
                                <cite className="block mt-4 font-semibold text-gray-900 text-center">Pepito Pérez, Guarda de Seguridad</cite>
                            </div>
                            <div className="  hover:scale-105 transition-transform p-6 rounded-lg  bg-white">
                                <blockquote className=" text-lg text-gray-700 text-center">
                                    "La implementación de SENAuthenticator ha mejorado significativamente la seguridad y la eficiencia en el control de acceso en nuestra institución. ¡Altamente recomendado!"
                                </blockquote>
                                <cite className="block mt-4 font-semibold text-gray-900 text-center">Emmanuel Castañeda, Coordinadora de Operaciones</cite>
                            </div>
                        </div>
                ...
                <section className="    h-[100vh] flex bg-custom-gris justify-center items-center w-full">
                    <div className='max-w-[80%] flex flex-col gap-16 justify-center items-center'>
                        <h2 className="text-7xl font-bold text-gray-900 mb-10">Últimas Noticias</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <article className="hover:scale-105 transition-transform p-6 rounded-lg border ">
                                <h3 className="text-2xl font-semibold text-gray-800 mb-4 text-center">Actualización de Seguridad</h3>
                                <p className="text-gray-700 text-center ">
                            ...
                            <article className="hover:scale-105 transition-transform p-6 rounded-lg border ">
                                <h3 className="text-2xl font-semibold text-gray-800 mb-4 text-center">Nuevo Socio Estratégico</h3>
                                <p className="text-gray-700 text-center ">
